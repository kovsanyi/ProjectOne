...
{
    public partial class PoUIEvents
    {
        ...
        public void SetCustom(PoUIEventType scriptType, string content)
        {
            ...
            if (Scripts.ContainsKey(scriptType))
            {
                ...
                PoLogger.Log(PoLogSource.Default, PoLogType.Warn, "Script replaced using SetCustom(PoUIScriptType, string) method: " + scriptType.ToString());
            }
